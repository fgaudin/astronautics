...
\subsubsection*{Vector or cross product}
	\begin{figure}[H]
		\centering
		\copyrightbox[r]{\includegraphics[width=0.4\linewidth]{img/right_hand_rule_cross_product}}{\textcopyright Acdx, CC BY-SA 3.0 \url{http://creativecommons.org/licenses/by-sa/3.0/>}, via Wikimedia Commons \url{https://commons.wikimedia.org/wiki/File:Right_hand_rule_cross_product.svg>}}
